...
s.pctAgreedLong = "在第 {{comment_id}} 條意見的投票者中， <b>{{pct}}%</b> 表示贊成。";
s.pctAgreedOfGroup = "群組 {{group}} 裡，有 <b>{{pct}}%</b> 的人贊成";
s.pctDisagreedOfGroup = "群組 {{group}} 裡，有 <b>{{pct}}%</b> 的人反對";
s.pctDisagreedLong = "在第 {{comment_id}} 條意見的投票者中， <b>{{pct}}%</b> 表示反對。";
s.pctAgreedOfGroupLong = "在群組 {{group}} 中，有 <b>{{pct}}%</b> 贊成第 {{comment_id}} 條意見。";
s.pctDisagreedOfGroupLong = "在群組 {{group}} 中，有 <b>{{pct}}%</b> 反對第 {{comment_id}} 條意見。";
s.commentSent = "意見已送出！";
