...
s.writeCommentHelpText = "Si votre point de vue n’est pas déjà représenté, <em>publiez</em> un avis!</i>";
...
s.tipCommentsRandom = "Les avis s’affichent de manière aléatoire. Ainsi, vous ne répondez directement à personne.";
s.tipOneIdea = "Subdivisez en plusieurs avis les avis trop longues qui traitent de plus d’une idée. Cela facilitera le vote.";
s.tipNoQuestions = "Une avis ne doit pas être présentée sous la forme d’une question. Les participants indiqueront s’ils sont en accord ou en désaccord avec votre avis.";
